...
SAML.prototype.checkSAMLStatus = function (xmlDomDoc) {
    ...
    // Error Handling
    return callback(new Error('Failed to get StatusCodeValue'), null, false);
  }
    ...
    // Error Handling
    return callback(new Error('Failed to get StatusMessage'), null, false);
  }
    ...
    // Error Handling
    return callback(new Error('Failed to get StatusDetail'), null, false);
  }
